...
In the wake of the Coronavirus pandemic, the Anti-Eviction Mapping Project in collaboration with tenants rights and other activist groups, tirelessly researched and documented emergency tenant protections and housing justice actions in repsonse to the economic crisis from COVID-19. This map is a result of that effort and allows viewers to search for legislation that affects their rights as a renter at the city, county, state/province, and national levels of government in the United States and internationally. The site serves as a crowdsourcing mechanism that allows viewers to submit local updates on emergency tenants rights legislation or housing justice actions they may be involved in. The content of the site has been translated in many different languages and will load based on the settings of the viewer's browser. I contributed cartographic design and web development to this project on a pro-bono basis during Spring and Summer of 2020. This was a collaborative process involving many members of the AEMP, tenants rights groups, and activist collectives and the result of many hours of hard work and dedication those involved creating and contributing to it.
...
<strong>Technologies Used:</strong>  - Javascript ES6  - LeafletJS  - CARTO  - PostgreSQL  - PostGIS  - Webpack 
  ...
  <a href="{{site.url}}{{site.baseurl}}/images/aemp-covid19-protections-04.jpg" target="_blank">
    ...
    <noscript>
      <img src="{{site.url}}{{site.baseurl}}/images/aemp-covid19-protections-04.jpg" width="100%" height="100%" alt="aemp-covid19-protections-04.jpg">
    </noscript>
  </a>
