---
title: "CSV Driven Story Maps"
layout: page
#date: # to do: back date
teaser: "Creating a story map using React, Leaflet, and a CSV file"
header: no
comments: true
tags:
  - Javascript
...
In this post I’ll describe the workflow and application structure I developed for creating an interactive “story map” for [Canopy](http://http://canopyplanet.org/) while I worked as a web developer for [GreenInfo Network](http://greeninfo.org), and how it was built in a way that allowed for changes to the story's **content** (copy, photos, and other media assets) as well as **map data layers** to happen in an iterative and timely manner.
...
Find the finished project [here](https://greeninfo-network.github.io/canopyplanet/index.html#1). 
